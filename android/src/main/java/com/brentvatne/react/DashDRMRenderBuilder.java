 ...
 * DASH streams.
 */
public class DashDRMRenderBuilder extends RenderBuilder {
    ...
    public DashDRMRenderBuilder(Context context, String userAgent, String url) {
        this(context, userAgent, url, AudioManager.STREAM_MUSIC);
    }

    public DashDRMRenderBuilder(Context context, String userAgent, String url, MediaDrmCallback drmCallback) {
        super(context, userAgent, url, AudioManager.STREAM_MUSIC);
        this.drmCallback = drmCallback;
    }

    public DashDRMRenderBuilder(Context context, String userAgent, String url, int streamType) {
    ...
    public void buildRenderers(EMExoPlayer player) {
        currentAsyncBuilder = new AsyncRendererBuilder(context, userAgent, uri, player, streamType, drmCallback);
    ...
    protected final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<MediaPresentationDescription>, UtcTimingCallback {
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url, EMExoPlayer player, int streamType, MediaDrmCallback drmCallback) {
